...
public class GameManager : MonoBehaviour
{
    ...
    */
    ...
    [Header("GAME EXTRAS")]
    [Tooltip("Timer component on game object is required if true")]
    public bool isTimed; //is there a game timer
    private string timer;
    //public access to timer
    public string Timer
    {
        get { return timer; }
        //value only set if isTimer is ture
        set { if (isTimed) { timer = value; } }
    }

    [Tooltip("Collection component on game object is required if true")]
    public bool hasCollection;//is there a collection component
    private string collection;
    public string Collection
    {
        get { return collection; }
        //value only set if isTimer is ture
        set { if (hasCollection) { collection= value; } }
    }
    ...
    void Update()
    {
        ...
        //If ESC is pressed and released quit game
    ...
    void SetGameDefaults()
    {
        ...
        //If there is a timer
        if (isTimed) { timer = "00:00"; } 
        else { timer="!!isTimer Not set GM"; Debug.LogWarning("!!isTimer Not set GM"); }

        if (hasCollection) { collection = "0/0"; } 
        else { collection = "!!hasCollection Not set GM"; Debug.LogWarning("!!hasCollection Not set GM"); }
        //set High Score
